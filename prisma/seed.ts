  ...
  const moduleToolDefinitions = [
    {
      ...
      description: "Riconosce ed estrae testo da PDF e immagini tramite il modulo OCR condiviso.",
    ...
    },
    {
      ...
      description: "Genera un documento DOCX, PDF o Markdown da testo o blocchi strutturati, riusando il contenuto prodotto dai nodi precedenti.",
      runtimeKind: "PYTHON_MODULE" as const,
