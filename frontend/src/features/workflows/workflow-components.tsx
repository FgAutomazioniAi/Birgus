...
export function RunResultsPanel({
  ...
  return (
    <aside className="w-80 overflow-y-auto border-l border-border-default bg-bg-surface p-4">
      <h3 className="mb-3 text-sm font-semibold uppercase tracking-wide text-text-muted">Risultati esecuzione</h3>
      {!latestRun ? (
        <p className="text-sm text-text-muted">Esegui il workflow per vedere qui lo stato e gli output dei passaggi.</p>
      ) : (
