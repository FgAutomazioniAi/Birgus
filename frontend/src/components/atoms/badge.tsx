...
const toneClasses: Record<BadgeTone, string> = {
  ...
  success:
    "bg-status-success-bg text-status-success-text ring-1 ring-status-success-text/20",
  warn: "bg-status-warn-bg text-status-warn-text ring-1 ring-status-warn-text/20",
  progress:
    "bg-status-progress-bg text-status-progress-text ring-1 ring-status-progress-text/20",
  danger:
    "bg-status-danger-bg text-status-danger-text ring-1 ring-status-danger-text/20",
};
