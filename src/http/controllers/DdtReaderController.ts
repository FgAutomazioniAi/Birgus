...
export class DdtReaderController {
  ...
  public constructor(service: DdtReaderService, moduleGuard: ModuleGuard, permissionGuard: PermissionGuard) {
  ...
  private sendError(reply: FastifyReply, error: unknown): void {
    ...
    console.error("[DdtReaderController] Unexpected error", error);
